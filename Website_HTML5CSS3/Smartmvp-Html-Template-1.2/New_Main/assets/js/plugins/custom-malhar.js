...
/*=============================
  VENBOX- LIGHTBOX FOR GALLERY AND VIDEOS
===============================*/
$('.venobox').venobox();
...
===============================*/
$('.tweet').twittie({
  apiPath : 'assets/js/plugins/api/tweet.php',
  count: 2,
...
$('.mailchimp-subscribe').ajaxChimp({
  ...
  url: "http://themedept.us9.list-manage.com/subscribe/post?u=63465a86fdd5f3b9fa31f9278&amp;id=52df53337f"
});
...
===============================*/
  ...
  var rend = new FSS.CanvasRenderer();
  ...
  function initialise(){
    scene.add(mesh);
    scene.add(light);
    container.appendChild(rend.element);
    window.addEventListener('resize', resize);
  }

  function resize(){
    rend.setSize(container.offsetWidth, container.offsetHeight);
  }
